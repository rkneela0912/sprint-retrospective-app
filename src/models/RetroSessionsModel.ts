...
export interface RetroSessionsBase {
  ID?: number;
  Title?: string;
  "Sprint#Id"?: number;
  "Status#Id"?: number;
...
export interface RetroSessionsRead extends RetroSessionsBase {
  Sprint?: SprintValue;
  Status?: StatusValue;
  Author?: AuthorValue;
  Editor?: EditorValue;
...
export interface RetroSessionsWrite extends RetroSessionsBase {
  Sprint?: string;
  Status?: string;
  Author?: AuthorValue;
  Editor?: EditorValue;
